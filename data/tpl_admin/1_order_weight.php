        ...
        <div class="portlet box grey">
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-advance table-hover">
                    <tbody>
                    <tr><td>1、请使用Excel创建一个.xls文件，格式如下<span class="font-red">（<a href="tpl/www/images/weight.xls" class="red" style="text-decoration: underline">点击下载模板</a>）</span>。</td></tr>
                    <tr><td>2、Excel表格一次不能大于2M，超过2M的请分批导入。</td></tr>
                    <tr><td>3、根据运单编号匹配重量。</td></tr>
        ...
        $("#saveorder").submit(function(){
            ...
            $(this).ajaxSubmit({
                ...
                'success':function(rs){
                    ...
                    if(rs.status != 'ok'){
                        if(!rs.content) rs.content = '导入重量失败';
                        alert(rs.content);
                        return false;
                    }
                    else
                    {
                        $.dialog.alert("成功导入重量",function(){
                            obj.$.dsy.reload();
                        },'succeed');
                    }
                }
