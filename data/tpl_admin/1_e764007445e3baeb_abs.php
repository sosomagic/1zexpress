<?php if(!defined("DSAIYIN_SET")){exit("<h1>Access Denied</h1>");} ?><!-- 文本表单项 -->
...
<input type="text" id="<?php echo $_rs['identifier'];?>" class="inp inp_<?php echo $_rs['identifier'];?>" name="<?php echo $_rs['identifier'];?>" style="<?php echo $_rs['form_style'];?>" value="<?php echo $_rs['content'];?>" />
<input type="button" value="选择图片" class="btn btn-success btn-xs btn_<?php echo $_rs['identifier'];?>" id="_btn_<?php echo $_rs['identifier'];?>" />
<input type="button" value="预览" class="btn btn-info btn-xs btn_<?php echo $_rs['identifier'];?>" id="_btn2_<?php echo $_rs['identifier'];?>" />
<input type="button" value="清除" class="btn btn-danger btn-xs btn_<?php echo $_rs['identifier'];?>" onclick="$('#<?php echo $_rs['identifier'];?>').val('');" />
<script type="text/javascript">
$(document).ready(function(){
	$("#_btn_<?php echo $_rs['identifier'];?>").click(function(){
...
<input type="text" id="<?php echo $_rs['identifier'];?>" class="inp inp_<?php echo $_rs['identifier'];?>" name="<?php echo $_rs['identifier'];?>" style="<?php echo $_rs['form_style'];?>" value="<?php echo $_rs['content'];?>" />
<input type="button" value="首页" class="btn btn-xs btn-success" id="_btn_<?php echo $_rs['identifier'];?>" />
<input type="button" value="网址库" class="btn btn-xs btn-warning" id="_btn2_<?php echo $_rs['identifier'];?>" />
<input type="button" value="访问" class="btn btn-xs blue" id="_btn3_<?php echo $_rs['identifier'];?>" />
<input type="button" value="清除" class="btn btn-xs btn-danger" onclick="$('#<?php echo $_rs['identifier'];?>').val('');" />
<script type="text/javascript">
$(document).ready(function(){
	//点击首页时
	$("#_btn_<?php echo $_rs['identifier'];?>").click(function(){
