<?php if(!defined("DSAIYIN_SET")){exit("<h1>Access Denied</h1>");} ?><style type="text/css">
...
$(document).ready(function(){
	var delay;
	var code_editor_<?php echo $_rs['identifier'];?> = CodeMirror.fromTextArea(document.getElementById("<?php echo $_rs['identifier'];?>"),{
		lineNumbers		: true,
		matchBrackets	: true,
		lineWrapping	: true,
		indentWithTabs	: true,
