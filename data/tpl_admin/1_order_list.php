            ...
            <div class="table-scrollable">
                <table class="table table-striped table-bordered table-advance table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php if($address[$key]['idcard_front']<>''){ ?><a href="javascript:address_idcard('<?php echo $address[$key]['idcard_front'];?>');void(0);"><img src="tpl/www/images/ico.png" width="16" height="13" title="预览身份证-正面"></a><?php } ?><?php if($address[$key]['idcard_back']<>''){ ?><a href="javascript:address_idcard('<?php echo $address[$key]['idcard_back'];?>');void(0);"><img src="tpl/www/images/ico.png" width="16" height="13" title="预览身份证-反面"></a><?php } else { ?><span class="font-red">无身份证照片</span><?php } ?></td>
