<?php if(!defined("DSAIYIN_SET")){exit("<h1>Access Denied</h1>");} ?><script id="<?php echo $_rs['identifier'];?>" type="text/plain" style="<?php echo $_rs['form_style'];?>"><?php echo $_rs['content'];?></script>
...
var toolbars_<?php echo $_rs['id'];?> = [[
	...
	<?php if($_rs['btn_info']){ ?>'dsyinfo',<?php } ?>
