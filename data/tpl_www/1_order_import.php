<?php if(!defined("DSAIYIN_SET")){exit("<h1>Access Denied</h1>");} ?><?php $this->assign("title","批量创建运单"); ?><?php $this->output("head_member","file"); ?>
    ...
    <div class="col-md-12">
        <div class="portlet box grey">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-bars"></i>批量创建运单</div>
            </div>
        ...
        <div class="portlet box grey">
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-advance table-hover" id="tab">
                    <tbody>
                    <tr><td>1、请使用Excel创建一个.xls文件，格式如下（<a href="tpl/www/images/importdata.xls" target="_blank" class="red" style="text-decoration: underline">点击下载模板</a>）。</td>
                    </tr>
