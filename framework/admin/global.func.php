<?php
/***********************************************************
	Filename: admin/global.func.php
	Note	: 后台通用函数加载
	Version : 2.0
	Web		: www.dsaiyin.com
...
function dsy_sys_menu()
{
	...
	{
		$GLOBALS['app']->error(P_Lang('导航菜单异常：无法获取后台导航菜单，请检查表dsy_sysmenu'));
	}
...
# 读取扩展
function get_dsy_ext($module,$words="id,identifier")
{
	if(!$module)
	{
