...
class html_control extends dsy_control
{
	private $obj;
	public function __construct()
	{
		...
		if(file_exists($this->dir_dsy.'www/global.func.php')){
			include_once($this->dir_dsy.'www/global.func.php');
		}
	}
