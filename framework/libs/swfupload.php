...
class swfupload_lib
{
	...
	function button($id,$js="")
	{
		...
		$html .= 'function dsy_swfupload_success_'.$id.'(file,serverData,responseReceived)'."\n";
		$html .= '{'."\n";
		...
		$html .= '}'."\n";
		$html .= 'function dsy_swfupload_upload_complete_'.$id.'(file)'."\n";
		$html .= '{'."\n";
		...
		$html .= 'upload_success_handler : upload_success_dsy_'.$input_id.','."\n";
		$html .= 'upload_complete_handler : upload_complete_dsy_'.$input_id.','."\n";
