...
class form_lib
{
	...
	{
		$this->dir_form = $GLOBALS['app']->dir_dsy.'form/';
	...
	public function format($rs)
	{
		...
		$mlist = get_class_methods($obj);
		if(in_array('dsy_format',$mlist))
		{
			$info = $obj->dsy_format($rs,$this->appid);
			$rs['html'] = $info;
			return $rs;
		}
	...
	public function get($rs)
	{
		...
		$mlist = get_class_methods($obj);
		if(in_array('dsy_get',$mlist)){
			return $obj->dsy_get($rs,$this->appid);
		}
	...
	public function show($rs,$value='')
	{
		...
		$mlist = get_class_methods($obj);
		if(in_array('dsy_show',$mlist)){
			return $obj->dsy_show($rs,$this->appid);
		}
