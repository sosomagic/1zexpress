...
class login_control extends dsy_control
{
	...
	public function save_f()
	{
        ...
        $this->session->assign('user_ucode',$user_rs['user_ucode']);
		$this->json(true);
	}
	...
	**/
	...
	{
		if($_SESSION['user_id']){
			$session = array('user_id'=>$_SESSION['user_id'],'user_name'=>$_SESSION['user_name'],'user_gid'=>$_SESSION['user_gid'],'user_ucode'=>$_SESSION['user_ucode']);
