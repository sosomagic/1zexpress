...
class list_model_base extends dsy_model
{
    ...
    function web_list()
    {
        $sql = "SELECT a.id,a.title,b.thumb,b.content,c.filename FROM ".$this->db->prefix."list a ";
        $sql.= "LEFT JOIN ".$this->db->prefix."list_22 b ON(a.id=b.id) ";
        $sql.= "LEFT JOIN ".$this->db->prefix."res c ON(b.thumb=c.id) ";
        $sql.= "where a.cate_id=608 AND a.status=1 ";
