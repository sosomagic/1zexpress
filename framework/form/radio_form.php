...
class radio_form extends _init_auto
{
    ...
    public function dsy_config()
    {
        ...
        $html = $this->dir_dsy."form/html/radio_admin.html";
    ...
    public function dsy_format($rs,$appid='admin')
    {
        ...
        if($appid == 'admin'){
            return $this->fetch($this->dir_dsy.'form/html/radio_admin_tpl.html','abs-file');
        }else{
            return $this->fetch($this->dir_dsy.'form/html/radio_www_tpl.html','abs-file');
        }
    }
    ...
    public function dsy_show($rs,$appid='admin')
    {
        ...
        if($appid == 'admin'){
            ...
            if($opt[0] == 'project'){
                return $this->call->dsy('_project',array('pid'=>$rs['content']));
            }
            if($opt[0] == 'cate'){
                return $this->call->dsy('_cate',array('cateid'=>$rs['content']));
            }
            if($opt[0] == 'title'){
                return $this->call->dsy('_arc',array('title_id'=>$rs['content']));
            }
            return $rs['content'];
        }
    }
