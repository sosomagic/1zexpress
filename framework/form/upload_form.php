...
class upload_form extends _init_auto
{
	...
	public function dsy_config()
	{
		...
		$html = $this->dir_dsy."form/html/upload_admin.html";
	...
	private function _format_admin($rs)
	{
		...
		return $this->fetch($this->dir_dsy.'form/html/upload_admin_tpl.html','abs-file',false);
	}
	...
	private function _format_default($rs)
	{
		...
		$this->assign("_rs",$rs);
		return $this->fetch($this->dir_dsy.'form/html/upload_www_tpl.html','abs-file',false);
	}
