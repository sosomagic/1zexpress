...
class upload_control extends dsy_control
{
	...
	**/
	...
	public function editopen_f()
	{
		...
		$this->view($this->dir_dsy."open/res_editopen.html",'abs-file',false);
	}
	...
	public function preview_f()
	{
		...
		$this->assign('rs',$rs);
		$this->view($this->dir_dsy."open/res_openview.html",'abs-file',false);
	}
