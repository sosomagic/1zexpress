<?php
/***********************************************************
	Filename: www/content_control.php
	Note	: 内容信息
	Version : 2.0
	Web		: www.dsaiyin.com
...
class content_control extends dsy_control
{
	...
	public function index_f()
	{
		...
		$project = $this->call->dsy('_project',array('pid'=>$rs['project_id']));
		...
		if($project['parent_id']){
			$parent_rs = $this->call->dsy("_project",array('pid'=>$project['parent_id']));
