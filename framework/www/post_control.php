<?php
/***********************************************************
	Filename: model/post_control.php
	Note	: 表单系统
	Version : 2.0
	Web		: www.dsaiyin.com
...
class post_control extends dsy_control
{
	...
	public function index_f()
	{
		...
		$project_rs = $this->call->dsy('_project',array("dsy"=>$id,'pid'=>$pid));
	...
	public function edit_f()
	{
		...
		//获取项目信息
		$project_rs = $this->call->dsy('_project','pid='.$rs['project_id']);
		if(!$project_rs || !$project_rs['module']){
